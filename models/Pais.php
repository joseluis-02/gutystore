...
Class Pais
{
	...
	{
		$sql="INSERT INTO pais (pais_nombre, pais_prefijo, pais_condicion)
		VALUES ('$nombre','$prefijo','1')";
		return ejecutarConsulta($sql);
	}

	//Implementamos un método para editar registros
	public function editar($id_pais,$nombre,$prefijo)
	{
		$sql="UPDATE pais SET pais_nombre='$nombre', pais_prefijo='$prefijo' 
	...
	{
		$sql="SELECT id_pais, pais_nombre, pais_prefijo, pais_condicion FROM pais WHERE id_pais='$id_pais'";
	...
	{
		$sql="SELECT id_pais, pais_nombre, pais_prefijo, pais_condicion FROM pais";
		return ejecutarConsulta($sql);		
	}

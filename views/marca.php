              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        <table style="width:100%"id="datatable_marca" class="display responsive nowrap table table-striped table-bordered table-condensed table-hover">
                          <thead>
                            <th>Nombre</th>
                            <th>Logo</th>
                            <th>Descripción</th>
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario_marca" id="formulario_marca" method="POST" enctype="multipart/form-data">
